...
public class ElementoChimico implements Comparable<ElementoChimico> {
    ...
    /*
     * AF: Un elemento chimico è rappresentato da un nome, simbolo, peso e numero
     * atomico
     * IR: nome, simboli != null nome e simbolo non vuot peso > 0 e 1<= nAtomico <=
     * 118 e simbolo con solo la prima lettera maiuscola
     */

    /**
     * Costruisce un {@code ElementoChimico} a partire dal nome, simbolo, peso e
     * numero atomico
     * 
     * @param nome     il nome
     ...
     * @throws IllegalArgumentException se nome o simbolo sono vuoti, peso <= 0,
     *                                  nAtomico <1 e > 118 e simbolo deve avere
     *                                  solo la prima lettere maiscola
    ...
    public ElementoChimico(String nome, String simbolo, float peso, int nAtomico) {
        ...
        if (peso <= 0)
            throw new IllegalArgumentException("Il peso non può essere <= 0");
        if (nAtomico <= 0 || nAtomico > 118)
            throw new IllegalArgumentException("Numero atomico non compreso tra 1 e 118");
    ...
    public ElementoChimico(final ElementoChimico el){
        this.nome = el.nome;
        this.simbolo = el.simbolo;
        this.peso = el.peso;
        this.nAtomico = el.nAtomico;
    }
